...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>All About Jude</title>
        <meta property="og:title" content="All About Jude" />
      </Helmet>
      <div className="home-hero">
        <div className="home-hero-text-container">
          <h1 className="home-heading">i am jude</h1>
          <span className="home-text">
            I am a weird hermit introvert that likes anime, math, and league of
            legends, a very odd combo. i also really like those little belgian
            waffles from costco. and monkeys. 
          </span>
        </div>
        <img
          alt="image"
          src="/playground_assets/img_2963%5B1%5D-min-1500w.jpg"
      ...
      <div id="features" className="home-features">
        <div className="home-heading-container">
          <h2 className="home-text01 section-Heading">Stuff I&apos;ve Done</h2>
        ...
        <div className="home-cards-container">
          <div className="home-feature-card">
            <img
              alt="image"
              src="/playground_assets/20221012_220826-min-200w.jpg"
              className="home-image1"
            />
            <span className="home-heading1 card-Heading">
              Me with Garnt and Joey from Trash Taste
            </span>
          ...
          <div className="home-feature-card1">
            <img
              alt="image"
              src="/playground_assets/20221012_220225-min-200w.jpg"
      ...
      <div id="services" className="home-services">
        <div className="home-service-card">
          <img
            alt="image"
            src="/playground_assets/20211030_220121-min-600w.jpg"
            className="home-image4"
          />
          <span>Me and the Boys in the shower at my house</span>
        </div>
        <div className="home-service-card1">
          <img
            alt="image"
            src="/playground_assets/20211204_232245-min-1500w.jpg"
            className="home-image5"
          />
          <span>Me and the Boys celebrating New Years in my basement</span>
        </div>
        <div className="home-service-card2">
          <div className="home-card-content">
            ...
            <button className="home-button anchor button">READ MORE</button>
          </div>
        </div>
      ...
      <div id="about-us" className="home-about-us">
        <div className="home-heading-container1">
          ...
          <button className="home-cta-btn button anchor">START BUILDING</button>
        </div>
      ...
      <div className="home-testimonials">
        <h2 className="home-text15 section-Heading">
      ...
      <div id="contact" className="home-contact">
        <div className="home-content-container">
          ...
          <div className="home-social-links-container">
            <svg viewBox="0 0 950.8571428571428 1024" className="home-icon42">
            ...
            <svg viewBox="0 0 877.7142857142857 1024" className="home-icon46">
